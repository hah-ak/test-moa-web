        ...
        <ol className={"relative border-l border-gray-200 dark:border-gray-700"}>
            ...
            <li className={"ml-6"}>
                ...
                <div className={"items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:bg-gray-700 dark:border-gray-600"}>
                    ...
                    <div className={"text-sm font-normal text-gray-500 lex dark:text-gray-300"}>Jese Leos has changed
                        <Link href="#" className={"font-semibold text-blue-600 dark:text-blue-500 hover:underline"}>Pricing page</Link>
                        task status to
                        <span className={"font-semibold text-gray-900 dark:text-white"}>Finished</span>
                    </div>
                </div>
            </li>
        </ol>
